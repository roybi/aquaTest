...
public class TestNG_ReportsAndLogs {
	...
	public void beforeMethod() {
		Reporter.log("TestNG_ReportsAndLogs -> this runs once before  Method",true);
	}

	@AfterMethod
	public void afterMethod() {
		Reporter.log("TestNG_ReportsAndLogs -> this runs once After  Method",true);
	}
	
	@Test
	public void testMethod1() {
		Reporter.log("TestNG_ReportsAndLogs -> Method 1",true);
	}
